...
fun FSDialog(
    ...
    val icon = when (isSuccess) {
        true -> FSTheme.icons.arrowLeft
        false -> FSTheme.icons.arrowLeft
        else -> null
    }
    val iconBg = if (isSuccess == true) FSTheme.colors.green else FSTheme.colors.red
    Dialog(
